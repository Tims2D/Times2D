...
class M4Summary:
    ...
    def evaluate(self):
        ...
        for group_name in M4Meta.seasonal_patterns:
            ...
            if os.path.exists(file_name):
                ...
                # Print the results for each individual seasonal pattern
                print(f"Results for {group_name}:")
                print('smape:', {group_name: grouped_smapes[group_name]})
                print('mape:', {group_name: grouped_mapes[group_name]})
                print('mase:', {group_name: model_mases[group_name]})
                print('owa:', {group_name: (model_mases[group_name] / naive2_mases[group_name] +
                                            grouped_smapes[group_name] / naive2_smapes[group_name]) / 2})
    ...
    def summarize_groups(self, scores):
        ...
        weighted_score = {}
        available_groups = [g for g in M4Meta.seasonal_patterns if g in scores]
